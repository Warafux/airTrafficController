...
namespace AirTrafficController
{
    public interface iAirplane
    {
        ...
        void Initialize(string id, Texture2D icon, string vendor, string model, Vector2 pos, Vector2 direction, int altitude, int speed, int maxSpeed, int acceleration, int verticalAcceleration, int capacity);
